<?php
$meta_description = 'Proces S.F.E.R.A. mentalnog treninga - kako izgleda rad sa S.F.E.R.A. metodom.';
$meta_keywords    = 'SFERA proces, mentalni trening, sport, mentalne vestine, Inner Dynamic Method';
$page_title       = 'Proces S.F.E.R.A. Mentalnog Treninga | Inner Dynamic Method';
$body_class       = 'singlepost single single-post body_style_wide body_filled article_style_stretch scheme_original top_panel_show top_panel_above sidebar_hide sidebar_outer_hide preloader wpb-js-composer sc_responsive';
$current_page     = 'proces-sfera-mentalnog-treninga';
...
$lang_en_url      = '/en/sfera-mental-training-process.php';
                    ...
                    <article class="post post_item_single">
                        <section class="post_content">
                            <h1 class="post_title entry-title">
                                ...
                                Proces S.F.E.R.A. Mentalnog Treninga
                            </h1>
                            ...
                            <p>Sadržaj će biti dodat naknadno.</p>
