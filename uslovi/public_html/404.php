        ...
        <!-- kraj menija-->
         <section class="top_panel_image">
            ...
            <div class="top_panel_image_header">
                ...
                <h1 class="top_panel_image_title entry-title">NA ŽALOST OVA STRANICA NIJE PRONAĐENA</h1>
                ...
                <div class="content">
                    <section class="">
                            <div class="post_thumb">
                                <a class="">
                                    <img width="300px" height="" alt="problemi" src="images/404.jpg" class="aligncenter">
                                </a>
                            </div>
                        </section>
                </div>
