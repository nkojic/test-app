                    ...
                    <article class="post post_item_single">
                        <section class="post_featured">
                            <div class="post_thumb" >
                                <a class="" >
                                    <img width="600px" height="" alt="bol - bowen blog" src="images/bol_u_vratu.webp">
                                </a>
                            </div>
                        </section>
...
<p>Bol je dobar. On je naš prijatelj koji nam ukazuje da nešto nije u redu. Pokazuje nam gde su nam granice. Daje nam mogućnost da se što pre pozabavimo sobom. 
Ljudima koji nemaju sposobnost da osete bol nije lako. Često, posledično tome, imaju velike zdravstvene probleme. Njihovi životi su veoma ograničeni i uslovljeni mnogim faktorima. Tako da, svi mi koji možemo osetiti bol smo, na neki način, blagosloveni.
Ipak, kao što rekoh, bol je znak i treba ga uvažiti i ispoštovati, ali to ne znači da treba da živimo sa njim. Da se srodimo. Da se naviknemo.</p>
<p>Iako često dobijamo informacije da neke stvari moraju da bole, ne moraju. Da je bol vezan za godine, ni to ne mora da bude tako. Da moramo da trpimo i čekamo da prođe. Zašto bi to neko u 21. veku radio?</p>
<p>Sada kada su nam, kao nikada do sada, dostupne informacije. Kada možemo da proučimo šta sve, potencijalno, može da nas dovede u bolno stanje, bio da se radi o akutnom ili hroničnom bolu. Kad postoji toliko načina kako možemo da izbegnemo ili preventiramo bilo kakvo bolno stanje. Takođe, toliko prirodnih suplemenata nam je na dohvat ruke, saveta o ishrani, dnevnih rutina, vežbi, tehnika i terapija. Stvarno je neprihvatiljivo da bio ko trpi bol.</p>
<p>Jedna od najprirodnijih, a veoma učinkovitih terapija, kako u obezbojavanju tako i u prevenciji bola, je Bowen terapija. Ova terapija je tako dizajnirana da, na prvom mestu, ne izaziva dodatni bol. Veoma nežnim i laganim pokretima, opušta mišiće, tetive, ligamente, fasciju što, odmah, dovodi do smanjenja bola. Takođe, direktno utiče na nervni sistem i započinje njegov proces regeneracije. Kod hroničnih bolova, prekida, već kreirane obrasce. Umu šalje signal da ne mora da bude u bolu, a telu daje šansu da se pokrene i vrati u zdravo stanje.</p>
Možete pitati bilo koga ko je u bolovima ili je bio, život bez bola je život sa ogromnim kvalitetom. Male promene, često, nešto što uzimamo zdravo za gotovo, čini veliku razliku.</p>
