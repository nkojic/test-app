<?php
$lang_sr_url = '/bowen_terapija_bez_bola_relaksacija_izlecenje.php';
                    ...
                    <article class="post post_item_single">
                        ...
                        <section class="post_content">
                            <h1 class="post_title entry-title">
                                ...
                                BOWEN THERAPY, RELAXATION AND HEALING
                            </h1>
                            
                            
<p>We are given a perfectly designed body, with all the mechanisms that can correct any error and return it to balance and a healthy state. However, sometimes, just like with the best and most advanced computer, a bug occurs that causes the system to become “confused” and blocked. In those moments, even though we possess everything needed to restore harmony, we look for a solution outside ourselves. Most often we reach for medications that imitate substances we already have in our body but that are, at that moment, unable to help us, and we mostly act only on the symptoms. Usually, if possible, we feel better, but we do not solve the cause, so the problem returns, repeats itself, or shifts into another form or to another level.</p>

<p>Bowen therapy is designed to help our body return to balance by gently and naturally initiating the process and guiding it back onto the right path. Bowen moves, which can be applied equally to babies, elderly people, and individuals in any condition or stage of illness, act on the part of the body that is not under our conscious control. Through the information transmitted by the movement, we influence the autonomic nervous system which, without our will, sends messages throughout the body. We activate mechanisms that start working and bring us back into balance.</p>

<p>The first effect of Bowen therapy is complete relaxation, which is also a prerequisite for healing. This therapy activates the body in a completely natural way, so there is no need for it to defend itself or block the healing process. In addition, it works from within, on our very foundation, and on all three levels (physical, mental, and emotional), thus covering and harmonizing all parts of our being.</p>

<p>It is ideal to use Bowen therapy preventively – to reset, raise energy, and release tension. Certainly, due to its comprehensive nature, pleasantness, and complete safety, this therapy is welcome at any moment. Therefore, if you have the opportunity, try Bowen therapy and surrender to its benefits – and if you don’t, create the opportunity ;)</p>
                        </section>
