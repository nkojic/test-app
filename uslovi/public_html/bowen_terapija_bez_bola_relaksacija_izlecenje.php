                    ...
                    <article class="post post_item_single">
                        <section class="post_featured">
                            <div class="post_thumb" >
                                <a class="" >
                                    <img width="600px" height="" alt="Bowen terapija, bez bola, relaksacija izlecenje" src="images/Bowen_terapija_bez bola_relaksacija_izlecenje.webp">
                                </a>
                            </div>
                        </section>
                        <section class="post_content">
                            <h1 class="post_title entry-title">
                                ...
                                BOWEN TERAPIJA, RELAKSACIJA I IZLEČENJE
                            </h1>
                            <!--
                            <div class="post_info">
...
<p>Dato nam je potpuno savršeno telo, sa svim mehanizmima koji mogu da isprave bilo kakvu grešku i vrate ga u balans i zdravo stanje. Ipak, nekada se desi, kao i kod najboljeg i najsavremenijeg kompjutera neki bug gde dolazi do “ zbunjivanja” sistema i blokade. U tim trenutcima, iako, posedujemo sve da uspostavimo harmoniju, mi tražimo rešenje izvan nas. Najčešće posežemo za lekovima koji imitiraju supstance koje mi već posedujemo u organizmu, ali su u tom trenutku onemogućene da nam pomognu, i delujemo, uglavnom, površinski na simptome. Najčešće, ako može, bude nam bolje, ali ne rešimo uzrok, pa se problem vraća, ponavlja ili prelazi u neki drugi oblik ili na neki drugi nivo.</p>

<p>Bowen terapija je dizajnirana da pomogne našem organizumu da se vrati u balans, tako što ga na veoma bezopasan i prirodan način pokreće i vraća na pravi put. Bowen pokreti, koji podjednako mogu da se rade i bebama i starijim ljudima, i osobama u bilo kom stanju i stadijumu bolesti, deluju na deo organizma koji nije pod našom voljom. Preko informacija koju prenosimo pokretom, utičemo na autonomni nervni sistem koji, bez naše volje, prenosi poruke organizmu. Aktiviramo mehanizme koji se pokreću i vraćaju nas u balans.</p>

<p>Prvi efekat Bowen terapije je jedna potpuna relaksacija, što je i preduslov za izlečenje. Ovom terapijom se organizam pokreće na potpuno prirodan način, tako da nema potrebu da se brani i koči proces isceljenja. Pored toga, deluje ka unutra, na našu osnovu, i to na sva tri nivoa (fizički, mentalni i emotivni), tako da pokriva i harmonizuje sve naše delove.</p>

<p>Idealno je koristiti Bowen terapiju preventivno, napraviti reset, podići energiju i otpustiti tenziju. Svakako, ova terapija, zbog svoje sveobuhvatnosti, prijatnosti i potpune sigurnosti, dobrodošla je u svakom trenutku. S’tim u vezi, ako Vam se ukaže prilika, probajte Bowen terapiju i prepustite se njenim dobrobitima, ako ne, napravite je ;)</p> 
