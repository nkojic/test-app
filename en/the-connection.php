<?php
$meta_description = 'The combination of coaching, Wingwave® and Points of You® creates a deeper and transformative process of change, working simultaneously on understanding, emotions and a new perspective.';
$meta_keywords    = 'coaching combination, Wingwave, Points of You, transformation, holistic coaching, change';
$page_title       = 'The Connection That Makes a Difference | Inner Dynamic Method';
$body_class       = 'singlepost single single-post body_style_wide body_filled article_style_stretch scheme_original top_panel_show top_panel_above sidebar_hide sidebar_outer_hide preloader wpb-js-composer sc_responsive';
$current_page     = 'spoj-koji-pravi-razliku';
$page_hero_icon   = 'icon-user';
$page_hero_title  = 'The Connection That Makes a Difference';
$page_hero_bg     = '../images/1170x700.jpg';
$header_scheme    = 'scheme_original';
$header_position  = 'top_panel_position_above';
$lang_sr_url      = '/spoj-koji-pravi-razliku.php';
$page_schema = '<script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","name":"The Connection That Makes a Difference","description":"The combination of coaching, Wingwave and Points of You creates a deeper and transformative process of change.","url":"https://innerdynamicmethod.rs/en/the-connection.php","isPartOf":{"@type":"WebSite","url":"https://innerdynamicmethod.rs"}}</script>';
                ...
                <div class="content">
                    <article class="post post_item_single">
                        <section class="post_content">
                            ...
                            <p>A space for clarity, insight and real change</p>
                            ...
                            <ul>
                                ...
                                <li>releasing emotional blocks</li>
                                <li>opening new perspectives</li>
                                <li>defining concrete steps</li>
                            </ul>
