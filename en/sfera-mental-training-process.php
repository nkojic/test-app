<?php
$meta_description = 'S.F.E.R.A. Mental Training Process - how the S.F.E.R.A. method works in practice.';
$meta_keywords    = 'SFERA process, mental training, sports, mental skills, Inner Dynamic Method';
$page_title       = 'S.F.E.R.A. Mental Training Process | Inner Dynamic Method';
...
$lang_sr_url      = '/proces-sfera-mentalnog-treninga.php';
                    ...
                    <article class="post post_item_single">
                        <section class="post_content">
                            <h1 class="post_title entry-title">
                                ...
                                S.F.E.R.A. Mental Training Process
                            </h1>
