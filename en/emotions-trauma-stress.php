<?php
$meta_description = 'Unprocessed emotions and stress create inner blocks. Wing Wave coaching helps release them without lengthy analysis, restoring balance and emotional freedom.';
$page_title       = 'Emotions, Trauma, Stress | Inner Dynamic Method';
...
$featured_image     = '../images/wing-wave-stranica.webp';
$featured_image_alt = '';
$page_hero_bg       = '../images/hero.webp';

$header_scheme   = 'scheme_original';
$header_position = 'top_panel_position_above';
$lang_sr_url     = '/emocije-trauma-stres.php';

$og_image          = '../images/wing-wave-emocije-trauma-stres.webp';
                    ...
                    <article class="post post_item_single">
                        <section class="post_content">
                            <div class="page-intro-image" style="text-align:center; margin-bottom:30px;">
                                <img loading="lazy" src="../images/wing-wave-stranica.webp" alt="Wing Wave Coaching" style="max-width:100%; height:auto;">
                            </div>
                            <h1 class="post_title entry-title">
                                <span class="post_icon <?php echo $page_hero_icon; ?>"></span>
                                Emotions, Trauma, Stress
                            </h1>
