<?php
$meta_description = 'Discover what a Wingwave session looks like, from defining the topic and the myostatic test to processing emotions through eye movements and integrating inner resources.';
$meta_keywords    = 'wingwave session, myostatic test, emotion processing, eye movements, relaxation, inner resources';
$page_title       = 'Wing Wave Session | Inner Dynamic Method';
$body_class       = 'singlepost single single-post body_style_wide body_filled article_style_stretch scheme_original top_panel_show top_panel_above sidebar_hide sidebar_outer_hide preloader wpb-js-composer sc_responsive';
$current_page     = 'wing-wave-sesija';
$page_hero_icon   = 'icon-book-open';
$page_hero_title  = 'Wing Wave Session';
$page_hero_bg     = '../images/1170x700.jpg';
$header_scheme    = 'scheme_original';
$header_position  = 'top_panel_position_above';
$lang_sr_url      = '/wing-wave-sesija.php';
$page_schema = '<script type="application/ld+json">{"@context":"https://schema.org","@type":"Service","name":"Wingwave Session","description":"What a Wingwave session looks like, from defining the topic and the myostatic test to processing emotions and integrating resources.","provider":{"@type":"ProfessionalService","name":"Inner Dynamic Method","url":"https://innerdynamicmethod.rs"},"serviceType":"Emotional Coaching","areaServed":{"@type":"Country","name":"Serbia"},"url":"https://innerdynamicmethod.rs/en/wing-wave-session.php"}</script>';
                    ...
                    <article class="post post_item_single">
                        <section class="post_content">
                            ...
                            <ul>
                                ...
                                <li>an inner block</li>
                                <li>an important life or business challenge</li>
