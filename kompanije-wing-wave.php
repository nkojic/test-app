<?php
$meta_description = 'Wing Wave Coaching za kompanije – Inner Dynamic Method. Oslobađanje stresa i mentalnih blokada u poslovnom okruženju.';
$page_title       = 'Wing Wave Coaching za kompanije | Inner Dynamic Method';
$body_class       = 'singlepost single single-post body_style_wide body_filled article_style_stretch scheme_original top_panel_show top_panel_above sidebar_hide sidebar_outer_hide preloader wpb-js-composer sc_responsive';
$current_page     = 'kompanije-wing-wave';
...
$lang_en_url     = '/en/companies-wing-wave.php';
$page_schema = '<script type="application/ld+json">{"@context":"https://schema.org","@type":"Service","name":"Wing Wave Coaching za kompanije","description":"Wing Wave Coaching za kompanije – oslobađanje stresa i mentalnih blokada u poslovnom okruženju.","provider":{"@type":"ProfessionalService","name":"Inner Dynamic Method","url":"https://innerdynamicmethod.rs"},"serviceType":"Wingwave Coaching","areaServed":{"@type":"Country","name":"Serbia"},"url":"https://innerdynamicmethod.rs/kompanije-wing-wave.php"}</script>';
