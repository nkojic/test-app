<?php
$meta_description = 'Inner Dynamic Method za sportske klubove – mentalni trening, sportski coaching i Wingwave® za sportiste i timove. Razvoj mentalne snage i vrhunskih performansi.';
$meta_keywords    = 'sportski klubovi, mentalni trening sportista, sportski coaching, Wingwave sport, performanse';
$page_title       = 'Sportski klubovi | Inner Dynamic Method';
...
$lang_en_url      = '/en/sports-clubs.php';
                ...
                <div class="content">
                    <article class="post post_item_single">
                        <section class="post_content">
                            ...
                            <p>Sadržaj stranice "Sportski klubovi" — biće dodat naknadno.</p>
                        </section>
                    </article>
                </div>
            </div>
