<?php
$meta_description = 'Saznajte kako izgleda Wingwave sesija — od definisanja teme i miostatskog testa do obrade emocija kroz pokrete očiju i integracije unutrašnjih resursa.';
$meta_keywords    = 'wingwave sesija, miostatski test, obrada emocija, pokreti očiju, relaksacija, unutrašnji resursi';
$page_title       = 'Wing Wave Sesija | Inner Dynamic Method';
                ...
                <div class="content">
                    <article class="post post_item_single">
                        <section class="post_content">
                            ...
                            <h2>3. Obrada emocija kroz pokrete očiju</h2>
