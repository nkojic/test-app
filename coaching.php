<?php
$meta_description = 'Coaching je prostor u kom počinju prave promene. Saznajte kako coaching pomaže da jasnije sagledamo sebe, pronađemo sopstvena rešenja i napravimo prvi korak ka promeni.';
$meta_keywords    = 'coaching, lični razvoj, coaching sesija, promena, Inner Dynamic Method, Beograd';
...
$page_schema = '<script type="application/ld+json">{"@context":"https://schema.org","@type":"Service","name":"Coaching","description":"Coaching je strukturisan proces koji pomaze ljudima da jasnije sagledaju sebe i pronadju sopstvena resenja.","provider":{"@type":"ProfessionalService","name":"Inner Dynamic Method","url":"https://innerdynamicmethod.rs"},"serviceType":"Coaching","areaServed":{"@type":"Country","name":"Serbia"},"url":"https://innerdynamicmethod.rs/coaching.php"}</script>';
