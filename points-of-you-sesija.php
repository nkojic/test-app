<?php
$meta_description = 'Points of You® sesija je drugačiji razgovor sa sobom — kroz slike, osećaje i ličnu priču dolazite do uvida koji pokreću stvarnu i autentičnu promenu.';
$meta_keywords    = 'points of you sesija, vizuelni coaching, uvidi, promena perspektive, autentičnost, fotografije';
...
$page_hero_title  = 'Points of You Sesija';
$featured_image     = '';
$featured_image_alt = '';
$page_hero_bg       = 'images/hero.webp';
$header_scheme   = 'scheme_original';
$header_position = 'top_panel_position_above';
$lang_en_url      = '/en/points-of-you-session.php';
$page_schema = '<script type="application/ld+json">{"@context":"https://schema.org","@type":"Service","name":"Points of You Sesija","description":"Points of You sesija je drugaciji razgovor sa sobom kroz slike i licnu pricu koji vodi do autenticne promene.","provider":{"@type":"ProfessionalService","name":"Inner Dynamic Method","url":"https://innerdynamicmethod.rs"},"serviceType":"Coaching","areaServed":{"@type":"Country","name":"Serbia"},"url":"https://innerdynamicmethod.rs/points-of-you-sesija.php"}</script>';
